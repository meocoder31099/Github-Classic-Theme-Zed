...
function getTheme({ style, name }: { style: Style, name: string }): Record<string, any> {
    ...
    return {
        ...
        style: {
            ...
            "element.background": pick({ light: "#e2e5e9", dark: primer.green[2] }),
            ...
            "text.disabled": null,
            "text.accent": pick({ light: primer.gray[7], dark: primer.gray[6] }),
            "icon": null,
            "icon.muted": null,
            "icon.disabled": null,
            ...
            "info.border": pick({ light: primer.gray[2], dark: primer.white }),
