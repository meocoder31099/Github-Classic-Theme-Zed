...
function getTheme({ style, name }: { style: Style, name: string }): Record<string, any> {
    ...
    return {
        ...
        style: {
            ...
            "error": primer.red[6],
            "error.background": alpha(primer.red[6] as string, .2),
            ...
            "hint": primer.muted,
            "hint.background": alpha(primer.gray[2] as string, .2),
            ...
            "info": primer.blue[6],
            "info.background": alpha(primer.blue[6] as string, .2),
            ...
            "warning.background": alpha(primer.yellow[6] as string, .2),
